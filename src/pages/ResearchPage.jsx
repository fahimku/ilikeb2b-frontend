...
export default function ResearchPage() {
  ...
  }, [page, limit, status, searchSubmitted]);
  ...
  const selectAll = () => {
    ...
    else setSelected(new Set(res.data.filter((r) => r.status === 'PENDING').map((r) => r._id)));
  };
                ...
                <tbody>
                  {res.data.map((r) => (
                    <tr key={r._id}>
                      ...
                      <td>{r.companyName ? 'Website' : 'LinkedIn'}</td>
